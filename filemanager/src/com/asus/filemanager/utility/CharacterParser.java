...
public class CharacterParser {
    private static int[] PY_NUMBER = new int[] {-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    public static String[] PY_STRING = new String[] {"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
    ...
    public String convert(String str) {
        ...
        if (ascii > 0 && ascii < 160) {
            ...
            for (int i = (PY_NUMBER.length - 1); i >= 0; i--) {
                if (PY_NUMBER[i] <= ascii) {
                    result = PY_STRING[i];
                    break;
                }
            }
