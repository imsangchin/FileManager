...
public class UnRarPreviewAdapter extends BaseAdapter implements OnClickListener{

    private static final String TAG = "UnRarPreviewAdapter";
    ...
    private UnRarDialogFragment mFragment;
    private ArrayList<UnZipPreviewData> mUnZipFileList;
    private UnZipPreviewData mCurrentFolder;

    public UnRarPreviewAdapter(UnRarDialogFragment fragment) {
        mFragment = fragment;
    }
