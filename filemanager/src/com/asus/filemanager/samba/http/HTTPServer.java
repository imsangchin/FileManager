...
import com.asus.filemanager.samba.util.ListenerList;
...
public class HTTPServer implements Runnable
{
	...
	/**
	 * timeout tcp 80*1000 Store the current TCP timeout value The
	...
	public boolean close()
	{
		...
		try
		{
			...
			Log.e(tag, "Close server:"+serverSock.getInetAddress().getHostAddress());
		}
		catch (Exception e)
		{
			//Debug.warning(e);
